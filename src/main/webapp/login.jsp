...
<meta charset="ISO-8859-1">
 ...
 <body> 
  ...
  <section>
	...
	<p style="color: white;">Username</p> <input type="text" name ="uid"> </br>
	  </div>
          <br>
          <br>
          <br>
	...
	<p style="color: white;">Password </p><input type="password" name="pass"> </br>
	 </div>
          <br>
          <br>
          <br>
	 ...
	 <div class="forget">
          <input type="checkbox" name="remember_me" > <label style="color: white;">Remember me</label>
        ...
        <input type="submit" name ="submit" value="login" id="btn">
            ...
            <p class="stafff">
              <a href ="Adminlogin.jsp "style="color: white;" > Log in as admin?  </a> 
             </p>  
              
               <p class="stafff">
              
               <a href ="insurancelogin.jsp"style="color: white;" > Log in as Insurance provider?  </a>   
