...
<body id="page-top">
	...
	<nav
		...
		id="mainNav">
		<div class="container">
			<a class="navbar-brand" href="#page-top">INSUURNCE OPTION</a>
			<button
	...
	<header class="masthead bg-primary text-white text-center">
		<div class="container d-flex align-items-center flex-column">
			...
			<img class="masthead-avatar mb-5" src="assets/img/avataaars.svg"
				alt="..." />
			<!-- Masthead Heading-->
			<h1 class="masthead-heading text-uppercase mb-0">Welcome Sakalabujan</h1>
			<!-- Icon Divider-->
			...
			<!-- Masthead Subheading-->
			<p class="masthead-subheading font-weight-light mb-0">VEHICLE RENTAL SYSTEM</p>
		</div>
	</header>
...
<div class="pro-list">
    ...
    <c:forEach var="pro" items="${prodetails}">
        <thead>
            	<tr>
                <td>Name :-</td>
                <td class="pro-name">${pro.name}</td>
                </tr>
                
                <tr>
                <td>Email :-</td>
                <td class="pro-email">${pro.email}</td>
                </tr>
                
                <tr>
                <td>Address :-</td>
                 <td class="pro-address">${pro.address}</td>
                </tr>
                
                <tr>
                <td>Mobile :-</td>
                <td class="pro-mobile">${pro.mobile}</td>
            	</tr>
        </thead>
    ...
    <form action="VehicleInsert" method="post">
        ...
        <select id="options" name="options">
            <option value="option1">Full Option </option>
            <option value="option2">Collision Insurance</option>
            <option value="option3">Liability Insurance</option>
            <option value="option3">3rd Party</option>
